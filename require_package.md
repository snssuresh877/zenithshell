...
| **Backlight & Power Management** | Native Sysfs/Login1 Engine (`brightnessctl` optional), `hypridle`, `hyprlock`, `hyprshade` | Hardware backlight slider, Wayland lock screen (`SUPER + L`), idle sleep, and night light shaders. |
